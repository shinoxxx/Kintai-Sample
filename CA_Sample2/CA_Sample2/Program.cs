...
namespace CA_Sample2
{
    class Program
    {
        ...
        public static class Define
        {
            ...
            public const string csStrTtlSum = "合計";
        ...
        static void Main(string[] args)
        {
            ...
            //strBeforePath = "C:\\Users\\Keita Shinohara\\Desktop\\sample.xlsx";
            if (strBeforePath == "")
            {
            ...
            //// デスクトップにコピーを作成
            //System.IO.File.Copy(strBeforePath, strAfterPath, true);
            ...
            //xlBook = xlBooks.Open(strAfterPath);
            // シートを選択する
            ...
            try
            {
                ...
                for (int iRowCnt = 9; iRowCnt <= 40; iRowCnt++)
                {
                    ...
                    //// Aカラムに「合計」が入力されていたら、ループを抜ける
                    //if (xlRange1.Value == Define.csStrTtlSum) { break; }
